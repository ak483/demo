...
PC_URL_ExcelDataList = (mainExcelDict['31周客服数据'])['着陆页面'].to_list()
PC_count_ExcelDataList = (mainExcelDict['31周客服数据'])['接通人数'].to_list()
PC_customer_ExcelDataList = (mainExcelDict['31周客服数据'])['入库客户数'].to_list()
PC_count_rate_ExcelDataList = (mainExcelDict['31周客服数据'])['咨询率'].to_list()
Target_URL_ExcelDataList = (mainExcelDict['目标1'])['目标url1'].to_list()
Baidu_fanke_ExcelDataList = (mainExcelDict['31周百度统计'])['访客数(UV)'].to_list()
Baidu_URL_ExcelDataList = (mainExcelDict['31周百度统计'])['页面URL'].to_list()
Baidu_Avg_state_ExcelDataList = (mainExcelDict['31周百度统计'])['平均停留时长（秒）'].to_list()
Baidu_Out_rate_ExcelDatalist = (mainExcelDict['31周百度统计'])['退出率'].to_list()
